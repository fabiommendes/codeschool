...
from file_types import ProgrammingLanguage
...
class AnswerKey(models.Model):
    ...
    placeholder = models.TextField(
        ...
        blank=True,
        help_text=_(
            'This optional value controls which code should be placed in '
            ...
            'per-language boilerplate and leave this value blank.'
        ),
    )
